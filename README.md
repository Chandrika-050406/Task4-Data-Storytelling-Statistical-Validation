...
Since the p-value is greater than 0.05, there is no statistically significant difference in average sales between male and female customers. Therefore, balanced marketing strategies are recommended instead of gender-specific campaigns.

# Business Recommendations
Increase investment in the Electronics category.
Ensure sufficient inventory for high-demand products.
Introduce promotional campaigns during low-performing months.
Continue inclusive marketing strategies.
Support business decisions through interactive dashboards and statistical analysis.
Project Outcome

This project demonstrates how data storytelling combined with statistical validation can help organizations make informed, data-driven business decisions.
